...
// Check API key (works for both OpenAI and OpenRouter keys)
const apiKey = import.meta.env.VITE_OPENAI_API_KEY || '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';
const isConfigured = apiKey && apiKey !== 'your_openai_api_key_here' && apiKey.startsWith('sk-');
